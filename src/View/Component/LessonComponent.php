...
class LessonComponent
{
    ...
    { ?>
        ...
        <div class="lesson event-list p-1 mt-2 rounded-lg overflow-y-auto min-h-fit" style="background-color: <?php echo LessonModel::getLessonColor($lesson->id)[0]->color ?>;">
